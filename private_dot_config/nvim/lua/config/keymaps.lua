...
local mappings = {
  ...
  { mode_n, "vv",      "<cmd>norm viw<cr>", { desc = "Select the current word" } },
  {
    mode_n,
    "<leader>j",
    "<cmd>Translate --endgines=google<cr>",
    { noremap = true, desc = "display the translation in a window" },
  },
  {
    mode_n,
    "M",
    ch_win_location,
    { noremap = true, desc = "change the location of window" },
  ...
  --  mode_v
  {
    ...
    "p",
    "P",
    { noremap = true, desc = "paste but not replace in visual mode" },
  },
  ...
  -- mode_i
  {
    ...
    "<C-o>",
    "<Esc>o",
    { noremap = true, desc = "go to the next line and enter insert mode" },
  },
  -- {
  --   mode_i,
  --   "<C-CR>",
  ...
  { mode_i, "<C-S-h>", "<C-w>",                             { noremap = true, desc = "Delete word" } },
  {
    ...
    { noremap = true, desc = "move to below windows in insert mode" },
  },
  {
    mode_i,
    "<C-k>",
    "<cmd>wincmd k<cr><cmd>stopinsert<cr>",
    { noremap = true, desc = "move to upper windows in insert mode" },
  },
  ...
  -- mode_""
  {
    ...
    "<S-l>",
    "$",
    { noremap = false, desc = "move to the end of line" },
  },
  {
    "",
    "<S-h>",
    "0",
    { noremap = false, desc = "move to the beginning of line" },
  },
